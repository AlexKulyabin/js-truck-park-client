...
import 'review_card_profile_model.dart';
export 'review_card_profile_model.dart';

class ReviewCardProfileWidget extends StatefulWidget {
  const ReviewCardProfileWidget({
    super.key,
  ...
  State<ReviewCardProfileWidget> createState() =>
      _ReviewCardProfileWidgetState();
}

class _ReviewCardProfileWidgetState extends State<ReviewCardProfileWidget> {
  late ReviewCardProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReviewCardProfileModel());
                    ...
                    children: [
                      Text(
                        valueOrDefault<String>(
                          widget!.reviewRow?.parkingAddress,
                          'No address',
                        ),
                        maxLines: 1,
