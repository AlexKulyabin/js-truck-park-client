    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case ParkingPhotosRow:
            return ParkingPhotosRow(data);
          case ParkingsRow:
            return ParkingsRow(data);
          case ReferralStatsRow:
            return ReferralStatsRow(data);
          case ReportsRow:
          ...
          case ViewFullParkingDetailsRow:
            return ViewFullParkingDetailsRow(data);
          case ViewReportsDetailedRow:
            return ViewReportsDetailedRow(data);
          case ViewReviewsWithUsersRow:
            return ViewReviewsWithUsersRow(data);
