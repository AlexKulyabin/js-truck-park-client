...
import 'create_parking_dialog2_model.dart';
export 'create_parking_dialog2_model.dart';

class CreateParkingDialog2Widget extends StatefulWidget {
  const CreateParkingDialog2Widget({super.key});

  @override
  State<CreateParkingDialog2Widget> createState() =>
      _CreateParkingDialog2WidgetState();
}

class _CreateParkingDialog2WidgetState
    extends State<CreateParkingDialog2Widget> {
  late CreateParkingDialog2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateParkingDialog2Model());
