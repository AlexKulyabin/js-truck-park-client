...
class ViewFullParkingDetailsTable
    extends SupabaseTable<ViewFullParkingDetailsRow> {
  @override
  String get tableName => 'view_full_parking_details';

  @override
  ViewFullParkingDetailsRow createRow(Map<String, dynamic> data) =>
      ViewFullParkingDetailsRow(data);
}

class ViewFullParkingDetailsRow extends SupabaseDataRow {
  ViewFullParkingDetailsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewFullParkingDetailsTable();
  ...
  dynamic? get allPhotos => getField<dynamic>('all_photos');
  set allPhotos(dynamic? value) => setField<dynamic>('all_photos', value);
